      ...
      <div>
        ...
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <Link href="/learn-more" className="px-8 py-3 rounded-xl bg-[#232834] border border-gray-600 text-white text-lg hover:bg-white hover:text-[#141a24] transition-colors font-semibold">Learn More</Link>
          </div>
